...
6. 当`点击`产生新标签页，下一个步骤（已做了拟真切换）又想回到原标签页，则需在下一个步骤的测试数据中指定标签页名称，如步骤10
...
| 4       |      | 点击 | 搜索按钮          |                  | 当前标签页为：百度 |
| 5       |      | 点击 | 搜索结果#1        |                  | 当前标签页为：百度，但点击操作后，浏览器会在新标签页打开豆瓣网站，框架已自动切换到新标签页 |
...
| 9       |      | 点击 | 搜索结果#1        | `#tab=百度`       | 当前标签页为：百度，但框架已自动切换到新标签页~~豆瓣2~~ |
